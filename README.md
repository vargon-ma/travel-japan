...
> สถานะปัจจุบัน: เสร็จ **Issue 01–05** — กริดการ์ด + แปลงค่าเงิน ¥/฿ + ฟิลเตอร์/ค้นหา/เรียง + แผนที่หลัก Leaflet ที่ปักหมุดทุก entry และ sync กับฟิลเตอร์ + โมดัลรายละเอียดพร้อมแกลเลอรีรูปและแผนที่ย่อ
> ยังไม่ทำ: **Issue 06–08** (บุ๊กมาร์ก, ชุดข้อมูลเต็ม + เครดิต, ขัดเกลา/แอนิเมชัน/responsive)
...
| `app.js` | ชั้น side-effect: `fetch`, render DOM, แผนที่หลัก Leaflet (sync ฟิลเตอร์), โมดัลรายละเอียด + แผนที่ย่อ (ต่อไปจะมี localStorage) |
