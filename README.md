...
> สถานะปัจจุบัน: เสร็จ **Issue 01–07** — กริดการ์ด + แปลงค่าเงิน ¥/฿ + ฟิลเตอร์/ค้นหา/เรียง + แผนที่หลัก Leaflet ที่ปักหมุดทุก entry และ sync กับฟิลเตอร์ + โมดัลรายละเอียดพร้อมแกลเลอรีรูปและแผนที่ย่อ + บุ๊กมาร์ก (localStorage) และฟิลเตอร์ "เฉพาะที่บุ๊กมาร์ก" + ชุดข้อมูลเต็ม 15 รายการ (3 ต่อหมวด × 5 หมวด) พร้อมหน้ารวมเครดิต/แหล่งอ้างอิงและที่มารูปภาพ
> ยังไม่ทำ: **Issue 08** (ขัดเกลา/แอนิเมชัน/responsive)
