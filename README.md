...
> สถานะปัจจุบัน: เสร็จ **Issue 01–06** — กริดการ์ด + แปลงค่าเงิน ¥/฿ + ฟิลเตอร์/ค้นหา/เรียง + แผนที่หลัก Leaflet ที่ปักหมุดทุก entry และ sync กับฟิลเตอร์ + โมดัลรายละเอียดพร้อมแกลเลอรีรูปและแผนที่ย่อ + บุ๊กมาร์ก (localStorage) และฟิลเตอร์ "เฉพาะที่บุ๊กมาร์ก"
> ยังไม่ทำ: **Issue 07–08** (ชุดข้อมูลเต็ม + เครดิต, ขัดเกลา/แอนิเมชัน/responsive)
